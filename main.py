...
app.secret_key = b'\xa8\xea\xe7*\x02(\xf0;m\xf6\xd4RS"\xb1\xc7\xc6\x9dK\x7f6\xd4ca'
db = SQLAlchemy(app)
...
if __name__ == "__main__":
    app.run(
        port=5000)  # here we are using a different port so as not to conflict with that allocated to our helloworld.py
